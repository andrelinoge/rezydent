 ...
 */
class ToursChildren extends BaseCatalogArticleTable
{
    const FORM_ID = 'form';
    ...
    {
        return array(
            'catalog_id' => ToursChildrenCatalog::getOptions( _('- Країна -' ), NULL, TRUE ),
        );
    }
    ...
    {
        return ToursChildrenCatalog::getOptions( _( 'Виберіть країну' ), TRUE );
    }
