 ...
 */
class ToursHealth extends BaseCatalogArticleTable
{
    const FORM_ID = 'form';
    ...
    {
        return array(
            'catalog_id' => ToursHealthCatalog::getOptions( _('- Категорія -' ), NULL, TRUE ),
        );
    }
    ...
    {
        return ToursHealthCatalog::getOptions( _( 'Виберіть категорію' ), TRUE );
    }
