...
/**
 * This is the model class for table "trip_companion".
 *
 * The followings are the available columns in table 'trip_companion':
 * @property integer $id
 * @property integer $parent_id
 * @property string $value
 */
class TripCompanion extends BaseCatalogTable
{
    const FORM_ID = 'trip_companion-form';
    /**
