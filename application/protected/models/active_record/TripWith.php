...
/**
 * This is the model class for table "trip_with".
 *
 * The followings are the available columns in table 'trip_with':
 * @property integer $id
 * @property integer $parent_id
 * @property string $value
 */
class TripWith extends BaseCatalogTable
{
    const FORM_ID = 'trip_with-form';
    /**
